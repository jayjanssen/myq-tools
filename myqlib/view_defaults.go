...
func DefaultViews() map[string]View {
	return map[string]View{
		`cttf`: NewNormalView( `Connections, Threads, Tables, and Files`,
			NewGroupCol( `Connects`, `Connection related metrics`, 0, 
			...
			NewGroupCol( `Threads`, `Thread related metrics`, 0,
			...
			NewGroupCol( `Pool`, `Thread Pool metrics`, 0,
			...
			NewGroupCol( `Tables`, `Table metrics`, 0,
			...
			NewGroupCol( `Defs`, `Table Definition Metrics`, 0,
			...
			NewGroupCol( `Files`, `File Metrics`, 0,
		...
		`throughput`: NewNormalView( `MySQL Server Throughput`,
			NewGroupCol( `Throughput`, `Bytes in/out of the server`, 0,
		...
		`query`: NewNormalView( `Query types and sorts`,
			...
			NewGroupCol(`Selects`, `Select Types`, 0,
			...
			NewGroupCol(`Sorts`, `Sort Types`, 0,
		...
		`handler`: NewNormalView(`Storage Engine Handler metrics`,
			NewGroupCol(`Reads`, `Handler read stats`, 0,
			...
			NewGroupCol(`Other`, `Other handler stats`, 0,
		...
		`innodb`: NewNormalView( `Innodb metrics`,
			NewGroupCol(`Row Operations`, `Row-level operations`, 0,
			...
			NewGroupCol(`Buffer Pool (pages)`, `Page-level operations`, 0,
		...
		`wsrep`: NewExtraHeaderView( `Galera Wsrep statistics`, 
			...
			NewGroupCol(`Cluster`, `Cluster-wide stats (at least according to this node)`, 0,
			...
			NewGroupCol(`Node`, `Node's specific state`, 0,
			...
			NewGroupCol(`Outbound`, `Sent replication events`, 0,
			...
			NewGroupCol(`Inbound`, `Received replication events`, 0,
			...
			NewGroupCol(`FlowC`, `Flow control stats`, 0,
			...
			NewGroupCol(`Cnflcts`, `Galera replication conflicts (on this node)`, 0,
			...
			NewGroupCol(`Gcache`, `Galera cache (gcache) information`, 0,
			...
			NewGroupCol( `Apply`, `Theoretical and actual apply efficiency`, 0,
		...
		`myisam`: NewNormalView( `MyISAM stats`,
			NewGroupCol(`Key Buffer`, `Key Buffer Stats`, 0,
			...
			NewGroupCol(`I/O`, `MyISAM Key Buffer IO Stats (not data)`, 0,
